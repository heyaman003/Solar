...
<div class="prod-links-row">
  <a href="${product.viewMoreUrl}" class="view-more-link">
    View More 
    <img src="./img/explore.svg" alt="Explore" class="default-img">
    <img src="./img/explore2.svg" alt="Explore Hover" class="hover-img">
  </a>
  <a href="${product.pdfUrl}" class="download-pdf-link" download>
    Download PDF 
    <img src="./img/download.svg" alt="Download" class="default-img">
    <img src="./img/download2.svg" alt="Download Hover" class="hover-img">
  </a>
</div>
        `;
